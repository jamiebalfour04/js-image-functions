/*
Copyright Jamie Balfour. You may not use this for any purpose other than
with the permission of the original copyright owner (Jamie Balfour).
*/

var BalfJSTools = new Object();
BalfJSTools.Image = new Object();
BalfJSTools.Image.Effects = new Object();
BalfJSTools.Image.Tools = new Object();
...
//Limits to 255
BalfJSTools.Image.Tools.ImageDataToImageTag = function(image_data, img_tag){
...
BalfJSTools.Image.Tools.CanvasLoadImageFromURL = function(link, canvas_context){
...
BalfJSTools.Image.Tools.LimitToColour = function(colour){
	if(colour > 255){
		return 255;
	}
	if(colour < 0){
...
BalfJSTools.Image.Tools.ImageDataFromImageTag = function(img){
	var canvas = document.createElement("canvas");
	var ctx = canvas.getContext("2d");
...
BalfJSTools.Image.Effects.IterateImage = function(image_data, application){
...
BalfJSTools.Image.Effects.InvertColour = function(image_data){
...
BalfJSTools.Image.Effects.Grayscale = function(image_data){
	return BalfJSTools.Image.Effects.IterateImage(image_data, function(pixel){
...
BalfJSTools.Image.Effects.Sepia = function(image_data){
	return BalfJSTools.Image.Effects.IterateImage(image_data, function(pixel){
...
BalfJSTools.Image.Effects.BlackAndWhite = function(image_data){
	return BalfJSTools.Image.Effects.IterateImage(image_data, function(pixel){
...
BalfJSTools.Image.Effects.FloodFill = function(image_data, x, y, colour){
...
BalfJSTools.Image.Effects.Darken = function(image_data){
	return BalfJSTools.Image.Effects.IterateImage(image_data, function(pixel){
